...
public class CountWords extends Configured implements Tool {
     ...
     private int runMapReduceJob(String path) throws IOException, InterruptedException, ClassNotFoundException {
         ...
         FileInputFormat.addInputPath(job, new Path(path+"/tok*"));
         FileOutputFormat.setOutputPath(job, new Path(path+"/CountWords"));
     ...
     public static void main(String[] args) throws Exception {
         ...
         System.exit(ToolRunner.run(new CountWords(), args));
     }
}
