...
public class Twokenize {
    ...
    // 20160621 erikt: first original line
    // static String decorations = "(?:[♫♪]+|[★☆]+|[♥❤♡]+|[\\u2639-\\u263b]+|[\\ue001-\\uebbb]+)";
    static String decorations = "(?:[♫♪]+|[★☆]+|[♥❤♡]+|[\\u2600-\\u27ff]+|[\\u1f300-\\u1f7ff]+|[\\ue001-\\uebbb]+)";
    ...
    // 20160621 : ; and ? added by erikt
    static String edgePunctChars    = "\\?:;'\"“”‘’«»{}\\(\\)\\[\\]\\*&"; //add \\p{So}? (symbols)
    static String edgePunct    = "[" + edgePunctChars + "]";
    // 20160621 _ added by erikt
    static String notEdgePunct = "[a-zA-Z0-9_À-ÖØ-öø-ÿ]"; // content characters
