...
public class Search extends Configured implements Tool {
     ...
     private int runMapReduceJob(String date, String search) throws IOException, InterruptedException, ClassNotFoundException {
         ...
         String outDir = "cache/"+date+"/Search/"+searchUrl;
     ...
     public int run(String[] arg0) throws Exception {
         return runMapReduceJob(arg0[0],arg0[1].toLowerCase());
     }
    
     public static void main(String[] args) throws Exception {
         if (args.length != 4) { // +2 because of -libjars files
             System.err.println("usage: search date searchterm (args="+args.length+")");
             System.exit(1);
         }
         System.exit(ToolRunner.run(new Search(), args));
     }
}
